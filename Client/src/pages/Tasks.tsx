  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-4 sm:mb-0">All Tasks</h1>
      ...
      {isAddingTask && (
        <div className="bg-white rounded-xl p-5 shadow-sm mb-6 animate-fadeIn">
          <h3 className="font-medium text-gray-800 mb-4">Add New Task</h3>
            ...
            <div className="space-y-3">
              {filteredTasks.map(task => {
                ...
                return (
                  <div 
                    key={task.id}
                    className="border border-gray-100 rounded-lg hover:shadow-sm transition-shadow"
                  >
                    <div className="p-4">
                      {category && (
                        <div className="mb-2">
